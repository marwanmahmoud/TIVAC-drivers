...
typedef struct {                                    /*!< GPIOA Structure                                                       */
  __IO uint32_t  DATA_Bits[255];										/*!< GPIO Bits Data                                                             */
...
/**
  * @brief Register map for TIMER peripheral (TIMER)
  */
...
/**
  * @brief Register map for WTIMER peripheral (WTIMER)
  */
...
/**
  * @brief Register map for USB peripheral (USB)
  */
...
#define WTIMER0                         ((WTIMER_Type             *) WTIMER0_BASE)
#define WTIMER1                         ((TIMER_Type              *) WTIMER1_BASE)
#define ADC0                            ((ADC_Type                *) ADC0_BASE)
#define ADC1                            ((ADC_Type                *) ADC1_BASE)
#define COMP                            ((COMP_Type               *) COMP_BASE)
#define CAN0                            ((CAN_Type                *) CAN0_BASE)
#define CAN1                            ((CAN_Type                *) CAN1_BASE)
#define WTIMER2                         ((TIMER_Type              *) WTIMER2_BASE)
#define WTIMER3                         ((TIMER_Type              *) WTIMER3_BASE)
#define WTIMER4                         ((TIMER_Type              *) WTIMER4_BASE)
#define WTIMER5                         ((TIMER_Type              *) WTIMER5_BASE)
